...
//   try{
// const response = await axios.get('https://vsysmalamat-ejh3ftcdbnezhhfv.westus2-01.azurewebsites.net/api/get_status_master/')
// // const data=response.data
...
//   try {
//      const response = await axios.post(`https://vsysmalamat-ejh3ftcdbnezhhfv.westus2-01.azurewebsites.net/api/get_sub_status_master/`,{
