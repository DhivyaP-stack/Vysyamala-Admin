...
import LogoDark from '../../newlogo copy.png';
import Logo from '../../newlogo copy.png';
...
const SignIn: React.FC<SignInProps> = ({ setIsAuthenticated }) => {
  ...
  return (
    <>
      ...
      <div className=" h-screen rounded-sm py-12 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      ...
                      >
                        <g opacity="0.5">
                          <path
                            d="M16.1043 9.625H15.3186V8.25C15.3186 5.86963 13.448 4 11.0677 4C8.68733 4 6.81665 5.86963 6.81665 8.25V9.625H6.03096C5.30409 9.625 4.71484 10.2142 4.71484 10.941V17.684C4.71484 18.4108 5.30409 19 6.03096 19H16.1043C16.8311 19 17.4203 18.4108 17.4203 17.684V10.941C17.4203 10.2142 16.8311 9.625 16.1043 9.625ZM8.22602 8.25C8.22602 6.52657 9.49224 5.26035 11.2157 5.26035C12.9391 5.26035 14.2054 6.52657 14.2054 8.25V9.625H8.22602V8.25ZM16.1043 17.684H6.03096V10.941H16.0876L16.1043 17.684Z"
                            fill=""
                          />
                        </g>
                      </svg>
                ...
                <div className="mb-5.5">
                  <button
                    type="submit"
                    className="w-full redbg rounded-lg bg-primary p-4 text-white transition hover:bg-opacity-90"
