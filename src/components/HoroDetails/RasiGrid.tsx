...
//     Array(12).fill([]),
//   );
//   console.log(rasiContents, 'rasiContents');
...
//     const value = rasiContents.map((contents, index) => {
...
//       }
//     });
//     const RasiValue = `{${value}}`;

//     onRasiContentsChange(RasiValue);
//   }, [rasiContents]);
...
// //   useEffect(() => {
// //   const gridData = rasiContents.map((gridContents, index) => {
...
// //   // Convert to JSON string before passing to parent
// //   onRasiContentsChange(JSON.stringify(gridData));
// // }, [rasiContents, centerLabel, onRasiContentsChange]);

// // For RasiGrid component
// useEffect(() => {
//   const gridData = rasiContents.map((gridContents, index) => {
//     if (gridContents.length === 0) {
//       return `Grid ${index + 1}: empty`;
...
//   onRasiContentsChange(formattedData);
// }, [rasiContents, centerLabel, onRasiContentsChange]);
