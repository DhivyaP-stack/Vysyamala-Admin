...
// import { annualIncomeApi, educationalPrefApi, getProfession } from '../../../action';
...
//     useEffect(()=>{
// if(profile){
//     const fromDate = profile[9].visibility_age_from
//     setValue('profileview.visibility_age_from',fromDate)
//     const toDate = profile[9].visibility_age_to
//         setValue('profileview.visibility_age_to',toDate)
//    const heightFrom = profession[9].visibility_height_from
//         setValue('profileview.visibility_height_from',heightFrom)
//    const heightTo = profession[9].visibility_height_to
//         setValue('profileview.visibility_height_to',heightTo)
...
//     <div className='w-full'>
//     <InputField label={''} placeholder='From' {...register('profileview.visibility_age_from')}/>
// </div>
// <div className='w-full'>
//     <InputField label={''} placeholder='To' {...register('profileview.visibility_age_to')}/>
// </div>
// </div>
//                  </div>
...
// <div className='flex gap-3 items-center justify-center'>
//     <div className='w-full'>
//     <InputField label={''} placeholder='From' {...register('profileview.visibility_height_from')}/>
// </div>
// <div className='w-full'>
//     <InputField label={''} placeholder='To' {...register('profileview.visibility_height_to')}/>
// </div>
// </div>
//                  </div>
...
//                 <label className="text-[20px] text-black font-semibold mb-2 max-md:text-[18px] mt-2">
//                   Family Status 
//                 </label>
//                 <div className="w-full inline-flex rounded max-md:flex-col">
//                   {/* {familyStatus.map((status) => ( */}
//                    {["Lower Middle Class","Middle Class","Rich","Very Rich","Affluent","Profession"].map((status) => (
//                     <label
...
//                 <button className='bg-blue-500 text-white px-15 py-2 rounded'>
...
//       // Set basic fields
//       setValue('profileview.visibility_age_from', visibility.visibility_age_from);
//       setValue('profileview.visibility_age_to', visibility.visibility_age_to);
//       setValue('profileview.visibility_height_from', visibility.visibility_height_from);
//       setValue('profileview.visibility_height_to', visibility.visibility_height_to);
      
//       // Set profession checkboxes
//       if (visibility.visibility_profession) {
//         const profIds = visibility.visibility_profession.split(',');
//         setSelectedProfessions(profIds);
//       }
      
//       // Set education checkboxes
//       if (visibility.visibility_education) {
//         const eduIds = visibility.visibility_education.split(',');
//         setSelectedEducations(eduIds);
//       }
      
//       // Set annual income
//       if (visibility.visibility_anual_income) {
//         // Assuming it's a single value or comma-separated list
//         const incomeIds = visibility.visibility_anual_income.split(',');
//         setValue('profileview.annualIncome', incomeIds[0]); // or handle multiple if needed
//       }
      
//       // Set family status
//       if (visibility.visibility_family_status) {
//         setValue('profileview.familyStatus', visibility.visibility_family_status);
//       }
      
//       // Set Dhosam and foreign interest radio buttons
//       setValue('profileview.rahuKetuDhosam', visibility.visibility_ragukethu);
//       setValue('profileview.chevvaiDhosam', visibility.visibility_chevvai);
//       setValue('profileview.foreignInterest', visibility.visibility_foreign_interest);
//     }
//   }, [profile, setValue]);
...
//                     label={''} 
//                     placeholder='From' 
//                     {...register('profileview.visibility_age_from')}
//                     readOnly
//                   />
//                 </div>
//                 <div className='w-full'>
...
//                     label={''} 
//                     placeholder='To' 
//                     {...register('profileview.visibility_age_to')}
//                     readOnly
//                   />
//                 </div>
//               </div>
...
//                     label={''} 
//                     placeholder='From' 
//                     {...register('profileview.visibility_height_from')}
//                     readOnly
//                   />
//                 </div>
//                 <div className='w-full'>
...
//                     label={''} 
//                     placeholder='To' 
//                     {...register('profileview.visibility_height_to')}
//                     readOnly
//                   />
//                 </div>
//               </div>
...
//                     id={`professionn-${profession.Profes_Pref_id}`}
//                     value={profession.Profes_name}
//                     checked={selectedProfessions.includes(profession.Profes_Pref_id.toString())}
//                     readOnly
//                   />
//                   <label
//                     htmlFor={`professionn-${profession.Profes_Pref_id}`}
...
//               <div className="w-full">
//                 <select
//                   {...register('profileview.annualIncome')}
//                   className="outline-none w-full px-4 py-2 border text-[#000000e6] font-medium border-black rounded"
//                   disabled
//                 >
//                   {annualIncome?.map((option: any) => (
...
//                       selected={profile?.profile_visibility?.visibility_anual_income?.split(',').includes(option.income_id.toString())}
//                       className='pl-1 text-[#000000e6] font-medium'
//                     >
//                       {option.income_description}
//                     </option>
...
//             </label>
//             <div className="w-full inline-flex rounded max-md:flex-col">
//               {["Lower Middle Class", "Middle Class", "Rich", "Very Rich", "Affluent", "Profession"].map((status, index) => (
//                 <label
//                   key={index}
//                   className='w-full px-5 py-3 text-sm font-medium border cursor-pointer'
//                 >
//                   <input
//                     type="radio"
//                     checked={profile?.profile_visibility?.visibility_family_status === (index + 1).toString()}
//                     className="w-0"
//                     readOnly
//                   />
//                   {status}
...
//                     type="radio"
//                     value="YES"
//                     checked={profile?.profile_visibility?.visibility_ragukethu === "YES"}
//                     className="mr-2"
//                     readOnly
//                   />
//                   Yes
...
//                     type="radio"
//                     value="NO"
//                     checked={profile?.profile_visibility?.visibility_ragukethu === "NO"}
//                     className="mr-2"
//                     readOnly
//                   />
//                   No
...
//                     type="radio"
//                     value="YES"
//                     checked={profile?.profile_visibility?.visibility_chevvai === "YES"}
//                     className="mr-2"
//                     readOnly
//                   />
//                   Yes
...
//                     type="radio"
//                     value="NO"
//                     checked={profile?.profile_visibility?.visibility_chevvai === "NO"}
//                     className="mr-2"
//                     readOnly
//                   />
//                   No
...
//                     type="radio"
//                     value="YES"
//                     checked={profile?.profile_visibility?.visibility_foreign_interest === "YES"}
//                     className="mr-2"
//                     readOnly
//                   />
//                   Yes
...
//                     type="radio"
//                     value="NO"
//                     checked={profile?.profile_visibility?.visibility_foreign_interest === "NO"}
//                     className="mr-2"
//                     readOnly
//                   />
//                   No
